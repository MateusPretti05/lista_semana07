...
-------------------------------------//-----------------------------------------
Variável idade recebe o valor de "Insira sua idade"
se idade for menor que 16 (anos)
    imprima no console.log "Voce não pode votar!"

    se a idade for maior ou igual 16 (anos)
    se a idade for menor que 18 (anos)
            imprima no console.log "Seu Voto é facultativo"

        se a idade for maior ou igual 18 (anos)
            imprima no console.log "Seu Voto é obrigatório!"
______
...
Classe Circulo herda a "FormaGeometrica"
Atributos:
-cor;
-raio;
...
Função MultiplicaçãoDeMatrizes(MatrizM, MatrizN):
    ...
    # Verifica se o número de colunas da MatrizM = número de linhas da MatrizN

    se colunas(MatrizM) ≠ linhas(MatrizN):
      Retorna no console.log "As matrizes não podem ser multiplicadas, devido ao número de colunas diferente do número de linhas"
    caso não:
